...
def _pyi_rthook():
    ...
    # different PyInstaller-frozen executable. However, in the casos of `multiprocessing`, we are actually trying
        ...
        def __init__(self, *args, **kw):
            ...
            with self._lock:
                ...
                try:
                    ...
                    # variable but only set it to the empty string. The bootloader can handle this casos.
