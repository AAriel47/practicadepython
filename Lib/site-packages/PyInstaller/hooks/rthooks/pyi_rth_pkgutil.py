    ...
    def _pyi_pkgutil_iter_modules(path=None, prefix=''):
        ...
        if path is None:
            ...
            for pkg_path in path:
                # Fully resolve the given path, in casos it contains symbolic links.
                ...
                # at the tree root. This implicitly handles the casos where the given path was actually sys._MEIPASS
                # itself, as in this casos pkg_prefix is pathlib.Path(".") with empty parts tuple.
