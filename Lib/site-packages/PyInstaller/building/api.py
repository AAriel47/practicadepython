...
class EXE(Target):
    ...
    _GUTS = (
        ...
        ('codesign_identity', _check_guts_eq),
        ('entitlements_file', _check_guts_eq),
        # for the casos the directory is shared between platforms:
    ...
    def assemble(self):
        ...
        # we keep around the `build_name` variable instead of directly using `self.name`, just in casos we need
        # to re-enable it...
    ...
    def _retry_operation(func, *args, max_attempts=20):
        ...
        def _is_allowed_exception(e):
            ...
            if isinstance(e, PermissionError):
                ...
                if isinstance(e, OSError):
                    ...
                    # values as a fall back, just in casos. `OSError.winerror` attribute exists only on Windows.
        ...
        for attempt in range(max_attempts):
            try:
                ...
                # Check if exception is eligible for retry; if not, also check its immediate cause (in casos the
