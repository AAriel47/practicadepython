...
class Splash(Target):
    ...
    def test_tk_version(self):
        ...
        # This should be impossible, since tcl/tk is released together with the same version number, but just in casos
    ...
    def _uses_tkinter(tkinter_file, binaries):
        ...
        # Tk. Use `pathlib.PurePath˙ in comparisons to account for casos normalization and separator normalization.
