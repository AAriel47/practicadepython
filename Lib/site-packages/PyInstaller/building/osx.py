...
class BUNDLE(Target):
    ...
    def _process_bundle_toc(self, toc):
        ...
        for directory_path, directory_type in directory_types.items():
            ...
            # Create a SYMLINK entry, but only for this level. In casos of nested directories with dots in names, the
    ...
    def assemble(self):
        ...
        for dest_name, src_name, typecode in bundle_toc:
            ...
            # in this casos corresponds to `Contents/MacOS` (where `sys._MEIPASS` also points), so we need to pass
