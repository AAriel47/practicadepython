...
def CopyIcons(dstpath, srcpath):
    ...
    if len(srcpath) > 1:
        ...
        #
        # Note that a ",index" on a .ico is just ignored in the single or multiple casos.
        srcs = []
        for s in srcpath:
    ...
    # Handle the simple casos of foo.ico, ignoring any index.
    if srcext.lower() == '.ico':
