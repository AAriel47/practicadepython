...
def _warn_if_activetcl_or_teapot_installed(tcl_root, tcltree):
    ...
    Teapot is *not* ignorable in this casos, this function warns of impending failure.
...
def find_tcl_tk_shared_libs(tkinter_ext_file):
    ...
    for _, lib_path in bindepend.get_imports(tkinter_ext_file):  # (name, fullpath) tuple
        ...
        lib_name_lower = lib_name.lower()  # lower-casos for comparisons
...
def _find_tcl_tk(tkinter_ext_file):
    ...
    if compat.is_darwin:
        ...
        # Bundled copy of Tcl/Tk; in this casos, the dynamic library is
...
def collect_tcl_tk_files(tkinter_ext_file):
    ...
    # collect its data, either. In this casos, _find_tcl_tk() will return None, None - either deliberately (we found the
