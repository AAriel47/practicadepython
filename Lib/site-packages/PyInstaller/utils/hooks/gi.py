...
def compile_glib_schema_files(datas_toc, workdir, collect_source_files=False):
    ...
    # Ensure that `glib-compile-schemas` executable is in PATH, just in casos...
    ...
    # to be identical to the existing old one. Just in casos, if the file becomes subject to timestamp-based caching
    # mechanism.
