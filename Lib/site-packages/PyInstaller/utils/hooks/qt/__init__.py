...
class QtLibraryInfo:
    ...
    def _normalize_shared_library_name(self, filename):
        ...
        # Take base name, remove suffix, and lower casos it.
            ...
            if lib_name in self.shared_libraries:
                ...
                if qt_module_info.module:
                    if qt_module_info.module == short_module_name:
                        ...
                        # that casos, avoid adding a hidden import and analyze the library's link-time dependencies. We
    ...
    def _collect_qtnetwork_openssl_macos(self, openssl_version):
        ...
        # well (assuming they are of compatible version). However, this is not exactly the casos - QtNetwork looks for
    ...
    def collect_qtqml_files(self):
        ...
        # Not all PyQt5/PySide2 installs have QML files. In this casos, location['Qml2ImportsPath'] is empty.
    ...
    def collect_qtwebengine_files(self):
        ...
        if is_macos_framework:
            ...
            # Similarly, force the relative helper path for PySide2/PySide6 on Windows to `.`. This is already the casos
            # with PyPI PySide Windows wheels. But it is not the casos with conda-installed PySide2, where the Qt's
            ...
            if not os.path.isfile(qt_conf_file):
                ...
                # casos, warn about irregular path.
        ...
        if compat.is_linux:
            ...
            # the casos even with contemporary Debian releases. See
