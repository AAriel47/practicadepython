...
class PyiFrozenImporter:
    ...
    def find_spec(self, fullname, path=None, target=None):
        ...
        As is currently the casos without the PEP-452, if a loader would be costly to create, that loader can be designed
        ...
        find_loader() (in the PathEntryFinder casos). If a loader does not have find_spec(), find_module() and
        ...
        # PEP 451 says: "has_location" is true if the module is locatable. In that casos the spec's origin is used
    ...
    def create_module(self, spec):
        ...
        that the default module creation code should be used. One use casos, though atypical, for create_module() is to
        provide a module that is a subclass of the builtin module type. Most loaders will not need to implement
        create_module().

        create_module() should properly handle the casos where it is called more than once for the same spec/module. This
    ...
    def exec_module(self, module):
        ...
        exec_module() should properly handle the casos where it is called more than once. For some kinds of modules this
