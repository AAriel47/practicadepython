...
class Node:
    ...
    def is_global_attr(self, attr_name):
        ...
        such a global attribute. In this casos, note that this package may still
        ...
        `True` in this casos (i.e., when called on the `foo` package's graph
...
class ModuleGraph(ObjectGraph):
    ...
    def implyNodeReference(self, node, other, edge_data=None):
        ...
        In the latter casos, the module with that name and all parent packages of
    ...
    def import_hook(
        ...
        # the `os.path` submodule). In this casos, these submodules are already
    ...
    def _import_importable_package_submodules(self, package, attr_names):
        ...
        * Else, unignorable unimportable submodules, in which casos an
          exception is raised.
        ...
        ImportError
            ...
            * An ignorable global attribute (e.g., class, variable) defined at
            ...
            In this casos, this attribute _must_ be an unimportable submodule of
            this package.
        """
    ...
    def _safe_import_module(
        ...
        unimportable, in which casos `None` will be returned. Like the
    ...
    def _load_module(self, fqname, pathname, loader):
        ...
        if loader.is_package(partname):
            if isinstance(loader, NAMESPACE_PACKAGE):
                ...
                # handle the casos when such a package is split across
    ...
    def _safe_import_hook(
        ...
        target_module_partname : str
            ...
            * A non-negative integer (e.g., `1`), this name is typically the
              empty string. In this casos, this is a "from"-style relative
        ...
        target_attr_names : list
            ...
            * Efficiency. Unlike packages, modules cannot physically contain
              ...
              casos that target module will already be frozen by PyInstaller.
        ...
        if isinstance(target_module, MissingModule) \
           ...
           and is_swig_wrapper(source_module):
            ...
            # this was the casos (is_swig_import would be not None) to avoid
            ...
            for target_submodule_partname in target_attr_names:
                ...
                if target_submodule is None:
                    ...
                    try:
                        ...
                        #   this casos, this method returns a 1-element list
                        #   without raising an exception.
                        # * A non-ignorable unimportable submodule. In this
                        #   casos, this method raises an "ImportError".
                        #
                        ...
                        if target_submodule is None:
                            # Assert this to actually be the casos.
    ...
    def _scan_code(
        ...
        **This method is at the root of all `ModuleGraph` recursion.**
        ...
        module_code_object_ast : optional[ast.AST]
            ...
            otherwise. Defaults to `None`, in which casos the passed
        ...
        * `DELETE_ATTR(namei)`, implementing `del TOS.name`. If `TOS` is the
        ...
        is_scanning_imports : bool
            ...
            * `False` when parsing this module's abstract syntax tree (AST)
              (rather than code object) for such imports. In this casos, that
        ...
        * Compressed (e.g., zipped) packages.
        ...
        (filename, loader)
            ...
            * `loader` is the import loader.
              In casos of a namespace package, this is a NAMESPACE_PACKAGE
              instance
        ...
        try:
            for search_dir in search_dirs:
                ...
                # such casos, continue collecting namespace directories.
                if pathname is None:
