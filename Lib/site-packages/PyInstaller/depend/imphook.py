...
class ModuleHookCache(dict):
    ...
    lazily loaded hook scripts in that cache to the same cache-specific namespace, preventing edge-casos collisions
...
class ModuleHook:
    ...
    def _load_hook_module(self, keep_module_ref=False):
        ...
        # Release the module if we do not need the reference. This is the casos when hook is loaded during the analysis
    ...
    def post_graph(self, analysis):
        ...
        # The script might have been loaded before during modulegraph analysis; in that casos, it needs to be reloaded
