...
class PyiModuleGraph(ModuleGraph):
    ...
    def _reset(self, user_hook_dirs):
        ...
        # files or data from another test-casos.
    ...
    def process_post_graph_hooks(self, analysis):
        ...
        #    this is the casos, all hook() functions defined in cached hooks for these modules will be called by the next
        #    iteration.
    ...
    def _safe_import_hook(
        ...
        if source_module is not None:
            ...
            if excluded_imports:
                ...
                # integer indicating the relative level. We do not use equality comparison just in casos we ever happen
    ...
    def get_importers(self, name):
        ...
        def get_importer_edge_data(importer):
            ...
            # edge might be None in casos an AliasModule was added.
            if edge is not None:
    ...
    def _metadata_from(self, package, methods=(), recursive_methods=()) -> set:
        ...
        require metadata for some distribution (which may not be its own) at runtime. In the casos of a match,
