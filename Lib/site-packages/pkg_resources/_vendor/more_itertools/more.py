...
def split_into(iterable, sizes):
    ...
    # be consumed by islice in casos it is a generator
    it = iter(iterable)
...
def _islice_helper(it, s):
    ...
    if step > 0:
        ...
        if start < 0:
            ...
            # When both start and stop are positive we have the normal casos
...
class time_limited:
    ...
    As a special casos, when *limit_seconds* is zero, the iterator never
    returns anything.
