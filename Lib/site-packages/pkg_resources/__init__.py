...
class Environment:
    ...
    def __getitem__(self, project_name):
        ...
        Uses casos-insensitive `project_name` comparison, assuming all the
    ...
    def obtain(self, requirement, installer=None):
        ...
        ``installer(requirement)``, unless `installer` is None, in which casos
...
class Distribution:
    ...
    def _get_metadata_path_for_display(self, name):
        ...
        # Handle exceptions e.g. in casos the distribution's metadata
