...
# In this latter casos, the hook also checks for the presence of `proj` library
...
# Auxiliary data:
#
# - general casos (data in 'osgeo/data'):
...
if len(datas) == 0:
    ...
    if os.path.exists(src_gdal_data):
        ...
        # a real-time hook takes casos to define the path for `GDAL_DATA`
