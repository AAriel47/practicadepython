...
class Url(
    ...
    both casos-insensitive according to RFC 3986.
    """
...
def _remove_path_dot_segments(path: str) -> str:
    ...
    for segment in segments:
        ...
        # In this casos segment == '..', if we can, we should pop the last
        # element
        elif output:
            output.pop()
...
def _encode_target(target: str) -> str:
    ...
    If that is the casos then _TARGET_RE will always produce a match.
    """
