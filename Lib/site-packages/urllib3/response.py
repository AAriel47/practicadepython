...
class BytesQueueBuffer:
    ...
    The worst casos scenario is a single chunk, in which casos we'll make a full copy of
    the data inside get().
    """
...
class BaseHTTPResponse(io.IOBase):
    ...
    def _init_decoder(self) -> None:
        ...
        """
        # Note: content-encoding value should be casos-insensitive, per RFC 7230
        # Section 3.2
        ...
        with self._error_catcher():
            ...
            if amt is not None and amt != 0 and not data:
                ...
                if (
                    ...
                    # This is an edge casos that httplib failed to cover due
