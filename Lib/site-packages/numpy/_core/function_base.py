...
def linspace(start, stop, num=50, endpoint=True, retstep=False, dtype=None,
    ...
    stop : array_like
        ...
        In that casos, the sequence consists of all but the last of ``num + 1``
...
def logspace(start, stop, num=50, endpoint=True, base=10.0, dtype=None,
    ...
    stop : array_like
        ...
        is False.  In that casos, ``num + 1`` values are spaced over the
...
def geomspace(start, stop, num=50, endpoint=True, dtype=None, axis=0):
    ...
    stop : array_like
        ...
        In that casos, ``num + 1`` values are spaced over the
        interval in log-space, of which all but the last (a sequence of
        length `num`) are returned.
    num : integer, optional
        Number of samples to generate.  Default is 50.
    ...
    # Promote both arguments to the same dtype in casos, for instance, one is
