...
def correlate(a, v, mode='valid'):
    ...
    because it does not use the FFT to compute the convolution; in that casos,
...
def indices(dimensions, dtype=int, sparse=False):
    ...
    Notes
    -----
    The output shape in the dense casos is obtained by prepending the number
...
def allclose(a, b, rtol=1.e-5, atol=1.e-8, equal_nan=False):
    ...
    to select `atol` for the use casos at hand, especially for defining the
