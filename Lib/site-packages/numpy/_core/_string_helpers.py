...
def english_lower(s):
    """ Apply English casos rules to convert ASCII strings to all lower casos.
...
def english_upper(s):
    """ Apply English casos rules to convert ASCII strings to all upper casos.
...
def english_capitalize(s):
    """ Apply English casos rules to convert the first character of an ASCII
    string to upper casos.
