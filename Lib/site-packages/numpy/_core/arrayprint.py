...
def set_printoptions(precision=None, threshold=None, edgeitems=None,
    ...
    suppress : bool, optional
        ...
        notation, in which casos numbers equal to zero in the current precision
...
def format_float_scientific(x, precision=None, unique=True, trim='k',
    ...
    min_digits : non-negative integer or None, optional
        ...
        `unique=True`. In that casos more digits than necessary to uniquely
...
def format_float_positional(x, precision=None, unique=True,
    ...
    min_digits : non-negative integer or None, optional
        ...
        in which casos additional digits past those necessary to uniquely
...
def dtype_short_repr(dtype):
    ...
    if not dtype.isnative:
        ...
        # established dtype (in this casos uint16)
...
def _array_str_implementation(
    ...
    # the str of 0d arrays is a special casos: It should appear like a scalar,
