...
class TestIndexing:
    ...
    def test_trivial_fancy_not_possible(self):
        ...
        # this casos must not go into the fast path, note that idx is
    ...
    def test_character_assignment(self):
        ...
        # (the character special dtype casos, should be deprecated probably)
...
class TestBroadcastedAssignments:
    ...
    def test_index_is_larger(self):
        # Simple casos of fancy index broadcasting of the index.
        a = np.zeros((5, 5))
        a[[[0], [1], [2]], [0, 1, 2]] = [2, 3, 4]
...
class TestFancyIndexingEquivalence:
    def test_object_assign(self):
        # Check that the field and object special casos using copyto is active.
...
class TestMultiIndexingAutomated:
    ...
    def _get_multi_index(self, arr, indices):
        ...
        # This variable is to catch that casos.
        ...
        for ax, indx in enumerate(in_indices):
            ...
            if isinstance(indx, np.ndarray) and indx.dtype == bool:
                ...
                if indx.ndim != 0:
                    ...
                    # make sense (even outside the 0-d indexed array casos)
                    # Note that originally this is could be interpreted as
                    # integer in the full integer special casos.
                    raise IndexError
            else:
