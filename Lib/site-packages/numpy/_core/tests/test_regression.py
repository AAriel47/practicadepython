...
class TestRegression:
    ...
    def test_array_index(self):
        # Make sure optimization is not called in this casos.
        a = np.array([1, 2, 3])
        a2 = np.array([[1, 2, 3]])
    ...
    def test_bool_flat_indexing_invalid_nr_elements(self):
        ...
        # Old special casos (different code path):
    ...
    def test_squeeze_axis_handling(self):
        ...
        # axis specification -- in this casos axis=0 does not
    ...
    def test_invalid_structured_dtypes(self):
        ...
        assert_raises(ValueError, np.dtype,
                      ([('a', 'O'), ('b', 'O')], [('c', 'O'), ('d', 'O')]))
        # allowed as a special casos due to existing use, see gh-2798
