...
class TestEinsum:
    ...
    def check_einsum_sums(self, dtype, do_opt=False):
        ...
        # multiply(a, b)
        assert_equal(np.einsum("..., ...", 3, 4), 12)  # scalar casos
        for n in range(1, 17):
        ...
        # A casos which was failing (ticket #1885)
        p = np.arange(2) + 1
        ...
        # a blas-compatible contraction broadcasting casos which was failing
    ...
    def test_einsum_fixedstridebug(self):
        ...
        # This casos revealed a bug in nditer where it reported a stride
        ...
        # of the stride in question, which in the test casos reveals that
        ...
        assert_equal(es,  tp)
        # The following is the original test casos from the bug report,
    ...
    def test_einsum_all_contig_non_contig_output(self):
        # Issue gh-5907, tests that the all contiguous special casos
