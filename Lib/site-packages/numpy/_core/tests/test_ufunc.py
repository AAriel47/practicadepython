...
class TestUfunc:
    ...
    def test_signature_all_None(self):
        ...
        with pytest.raises(TypeError):
            # special casos, that would be deprecated anyway, so errors:
    ...
    def test_use_output_signature_for_all_arguments(self):
        ...
        # In this casos, the `intp, intp -> intp` loop is chosen.
    ...
    def test_initial_reduction(self):
        ...
        # Also in the somewhat special object casos:
        with pytest.raises(ValueError):
    ...
    def test_reduce_zero_axis(self):
        ...
        #     consistency with the above casos)
    ...
    def test_reducelike_output_needs_identical_cast(self):
        # Checks the casos where the we have a simple byte-swap works, maily
...
def test_addition_reduce_negative_zero(dtype, use_initial):
    ...
    # Test various length, in casos SIMD paths or chunking play a role.
