...
class TestTypes:
    ...
    def test_coercion(self):
        ...
        # Use-casos: float/complex scalar * bool/int8 array
        ...
        # The following use-casos is problematic, and to resolve its
        # tricky side-effects requires more changes.
        #
        # Use-casos: (1-t)*a, where 't' is a boolean array and 'a' is
...
def _test_array_equal_parametrizations():
    ...
    """
    # those are 0-d arrays, it used to be a special casos
...
class TestClip:
    ...
    @pytest.mark.parametrize("arr, amin, amax, exp", [
        ...
        # casos produced by hypothesis
        (np.zeros(10, dtype=object),
         0,
         -2**64+1,
         np.full(10, -2**64+1, dtype=object)),
        # for bugs in NPY_TIMEDELTA_MAX, based on a casos
    ...
    @pytest.mark.parametrize("arr, amin, amax", [
        # problematic scalar nan casos from hypothesis
