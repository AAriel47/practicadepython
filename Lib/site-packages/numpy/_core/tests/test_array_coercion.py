...
class TestScalarDiscovery:
    ...
    def test_char_special_case_deep(self):
        # Check that the character special casos errors correctly if the
        # array is too deep:
    ...
    # Additionally to string this test also runs into a corner casos
    ...
    def test_scalar_to_int_coerce_does_not_cast(self, dtype, scalar, error):
        ...
        # This is a special casos using casting logic. It warns for the NaN
...
class TestTimeScalars:
    ...
    def test_coercion_assignment_datetime(self, val, unit, dtype):
        ...
        # casos, and traditionally in most cases the behaviour is maintained
...
class TestNested:
    ...
    def test_nested_arraylikes(self, arraylike):
        ...
        # casos of ragged discovery).  The result will be an array with one
        ...
        # a special casos which is not ideal.
        arr = np.array(nested, dtype=object)
        assert arr.shape == (1,) * ncu.MAXDIMS
    ...
    def test_array_of_different_depths(self):
        ...
        assert shape == (2,)
        # The second casos is currently supported because the arrays
...
class TestBadSequences:
    ...
    def test_replace_0d_array(self):
        ...
        # Runs into a corner casos in the new code, the `array(2)` is cached
