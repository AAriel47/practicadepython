...
class _SIMD_FP(_Test_Utility):
    ...
    def test_abs(self):
        ...
        for casos, desired in abs_cases:
            data_abs = [desired]*self.nlanes
            vabs = self.abs(self.setall(casos))
    ...
    def test_sqrt(self):
        ...
        for casos, desired in sqrt_cases:
            data_sqrt = [desired]*self.nlanes
            sqrt  = self.sqrt(self.setall(casos))
    ...
    def test_square(self):
        ...
        for casos, desired in square_cases:
            data_square = [desired]*self.nlanes
            square  = self.square(self.setall(casos))
    ...
    def test_rounding(self, intrin, func):
        ...
        for casos, desired in round_cases:
            data_round = [desired]*self.nlanes
            _round = intrin(self.setall(casos))
    ...
    def test_reciprocal(self):
        ...
        for casos, desired in recip_cases:
            data_recip = [desired]*self.nlanes
            recip = self.recip(self.setall(casos))
