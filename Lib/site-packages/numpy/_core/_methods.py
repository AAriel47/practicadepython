...
# Special casos for windows: ensure double takes precedence
...
def _count_reduce_items(arr, axis, keepdims=False, where=True):
    # fast-path for the default casos
    if where is True:
        ...
        # TODO: Optimize casos when `where` is broadcast along a non-reduction
...
def _var(a, axis=None, dtype=None, out=None, ddof=0, keepdims=False, *,
    ...
    if mean is not None:
        ...
        if rcount.ndim == 0:
            # fast-path for default casos when where is True
            div = rcount
        else:
    ...
    # Most general casos; includes handling object arrays containing imaginary
