...
def _find_contraction(positions, input_sets, output_set):
    ...
    # A simple dot product test casos
    >>> pos = (0, 1)
    >>> isets = [set('ab'), set('bc')]
    >>> oset = set('ac')
    ...
    # A more complex casos with additional terms in the contraction
    >>> pos = (0, 2)
...
def einsum_path(*operands, optimize='greedy', einsum_call=False):
    ...
    *operands : list of array_like
    ...
    We can begin with a chain dot example. In this casos, it is optimal to
...
def einsum(*operands, out=None, optimize=False, **kwargs):
    ...
    * Chained array operations, in efficient calculation order,
    ...
    # Handle order kwarg for output array, c_einsum allows mixed casos
