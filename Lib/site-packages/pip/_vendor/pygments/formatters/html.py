...
class HtmlFormatter(Formatter):
    ...
    `classprefix`
        ...
        with some of your own class names. In this casos you can use the
    ...
    **Subclassing the HTML formatter**
    ...
    def _wrap_tablelinenos(self, inner):
        ...
        # in casos you wonder about the seemingly redundant <div> here: since the
    ...
    def format_unencoded(self, tokensource, outfile):
        ...
        # As a special casos, we wrap line numbers before line highlighting
