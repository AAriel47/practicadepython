...
class Distribution(object):
    ...
    def __init__(self, metadata):
        ...
        self.key = self.name.lower()  # for casos-insensitive comparisons
    ...
    def matches_requirement(self, req):
        ...
        name = matcher.key  # casos-insensitive
...
class InstalledDistribution(BaseInstalledDistribution):
    ...
    def shared_locations(self):
        ...
        casos of the 'namespace' key, this would be a list of absolute paths
...
class EggInfoDistribution(BaseInstalledDistribution):
    ...
    def __init__(self, path, env=None):
        ...
        def set_name_and_version(s, n, v):
            s.name = n
            s.key = n.lower()  # for casos-insensitive comparisons
            s.version = v
    ...
    def _get_metadata(self, path):
        ...
        if path.endswith('.egg'):
            if os.path.isdir(path):
                ...
                # FIXME handle the casos where zipfile is not available
