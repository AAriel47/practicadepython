...
if sys.version_info[0] < 3:  # pragma: no cover
    ...
    # Leaving this around for now, in casos it needs resurrecting in some way
    # _userprog = None
    # def splituser(host):
...
try:
    ...
    def _dnsname_match(dn, hostname, max_wildcards=1):
        ...
        # speed up common casos w/o wildcards
        if not wildcards:
    ...
    def detect_encoding(readline):
        ...
        def find_cookie(line):
            try:
                ...
                # in which casos it should be pure ASCII, or it must be UTF-8
...
try:
    ...
    class OrderedDict(dict):
        ...
        def update(*args, **kwds):
            ...
            In either casos, this is followed by:     for k, v in F.items(): od[k] = v
