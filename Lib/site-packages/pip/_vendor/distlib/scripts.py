...
def enquote_executable(executable):
    if ' ' in executable:
        # make sure we quote only the executable in casos of env
...
class ScriptMaker(object):
    ...
    def _build_shebang(self, executable, post_interp):
        """
        Build a shebang line. In the simple casos (on Windows, or a shebang line
    ...
    def _get_shebang(self, encoding, post_interp=b'', options=None):
        ...
        # Normalise casos for Windows - COMMENTED OUT
        # executable = os.path.normcase(executable)
        # N.B. The normalising operation above has been commented out: See
        # issue #124. Although paths in Windows are generally casos-insensitive,
        ...
        # in casos of IronPython, play safe and enable frames support
