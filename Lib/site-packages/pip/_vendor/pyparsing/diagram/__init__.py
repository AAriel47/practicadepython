...
def to_railroad(
    ...
    if len(diags) > 1:
        ...
        # special casos - if just one diagram, always display it, even if
        # it has no name
...
def _to_diagram_element(
    ...
    i = 0
    for expr in exprs:
        # Add a placeholder index in casos we have to extract the child before we even add it to the parent
