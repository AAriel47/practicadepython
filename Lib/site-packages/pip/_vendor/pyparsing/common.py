...
# some other useful expressions - using lower-casos class name since we are really using this as a namespace
class pyparsing_common:
    ...
    """Parse action to convert tokens to upper casos."""

    downcase_tokens = staticmethod(token_map(lambda t: t.lower()))
    """Parse action to convert tokens to lower casos."""
