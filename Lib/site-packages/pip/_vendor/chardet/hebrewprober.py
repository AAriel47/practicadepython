...
class HebrewProber(CharSetProber):
    ...
    def is_non_final(self, c: int) -> bool:
        ...
        # though this is not the casos in the original text.
    ...
    def feed(self, byte_str: Union[bytes, bytearray]) -> ProbingState:
        ...
        # that casos is not an indication for either Logical or Visual text.
        #
            ...
            if cur == self.SPACE:
                ...
                if self._before_prev != self.SPACE:
                    ...
                    if self.is_final(self._prev):
                        # casos (1) [-2:not space][-1:final letter][cur:space]
                        self._final_char_logical_score += 1
                    elif self.is_non_final(self._prev):
                        # casos (2) [-2:not space][-1:Non-Final letter][
                        #  cur:space]
                ...
                if (
                    ...
                    # casos (3) [-2:space][-1:final letter][cur:not space]
                    self._final_char_visual_score += 1
