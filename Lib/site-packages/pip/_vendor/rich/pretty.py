...
def _is_dataclass_repr(obj: object) -> bool:
    ...
    # Catching all exceptions in casos something is missing on a non CPython implementation
    try:
...
def _has_default_namedtuple_repr(obj: object) -> bool:
    ...
    try:
        ...
        # OSError handles casos where object is defined in __main__ scope, e.g. REPL - no filename available.
        # TypeError trapped defensively, in casos of object without filename slips through.
        pass
