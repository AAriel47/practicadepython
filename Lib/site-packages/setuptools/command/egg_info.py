...
class InfoCommon:
    ...
    def _maybe_tag(self, version):
        ...
        in which casos the version string already contains all tags.
        """
        return (
            version
...
class egg_info(InfoCommon, Command):
    ...
    def finalize_options(self):
        ...
        # casos in a fresh checkout, make sure that any special tags get added
        # to the version info
        #
    ...
    def write_or_delete_file(self, what, filename, data, force=False):
        ...
        unless `filename` exists, in which casos a warning is issued about the
