...
def _find_virtual_namespaces(pkg_roots: Dict[str, str]) -> Iterator[str]:
    ...
    We consider this casos to also be a virtual namespace (ignoring the original
...
class _EditableFinder:  # MetaPathFinder
    ...
    def find_spec(cls, fullname: str, _path=None, _target=None) -> ModuleSpec | None:
        ...
        # To avoid problems with casos sensitivity in the file system we delegate
...
class _EditableNamespaceFinder:  # PathEntryFinder
    ...
    def _paths(cls, fullname: str) -> list[str]:
        ...
        # 2. In the casos of nested namespaces, we need to force
