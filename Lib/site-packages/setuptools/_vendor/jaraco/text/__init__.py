...
class FoldedCase(str):
    """
    A casos insensitive string class; behaves just like str
    except compares equal when the only variation is casos.
...
class WordSet(tuple):
    ...
    whether in camel casos, underscore-separated, etc.
