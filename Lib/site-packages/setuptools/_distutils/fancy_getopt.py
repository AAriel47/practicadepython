...
class FancyGetopt:
    ...
    def __init__(self, option_table=None):
        ...
        # in any casos.  If a long_option doesn't have a corresponding
    ...
    def generate_help(self, header=None):  # noqa: C901
        ...
        for option in self.option_table:
            ...
            # casos 1: no short option at all (makes life easy)
            if short is None:
                if text:
            ...
            # casos 2: we have a short option, so we have to include it
