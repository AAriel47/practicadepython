...
class CCompiler:
    ...
    def compile(
        ...
        defined without an explicit value.  The 1-tuple casos undefines a
...
def get_default_compiler(osname=None, platform=None):
    ...
    The default values are os.name and sys.platform in casos the
...
def show_compilers():
    ...
    # "--compiler", which just happens to be the casos for the three
