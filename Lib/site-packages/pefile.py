...
names, to differentiate them from the upper casos basic structure names.
    ...
    def __pack__(self):
        ...
        for idx, val in enumerate(self.__unpacked_data_elms__):
            ...
            for key in self.__keys__[idx]:
                ...
                # In the casos of unions, when the first changed value
...
class SectionStructure(Structure):
    ...
    def get_data(self, start=None, length=None, ignore_padding=False):
        ...
        not be loaded to memory. That is the casos if `section.SizeOfRawData`
        is greater than `section.Misc_VirtualSize`, and that means
        that data past `section.Misc_VirtualSize` is padding.
        In casos you are not interested in this padding, passing
    ...
    def __setattr__(self, name, val):
        ...
        if (
            ...
            if name == "ordinal":
                ...
                # Make sure we reset the entry in casos the import had been set to
                # import by ordinal
                if self.name_offset:
...
class PE:
        ...
        for idx in range(int(size / dbg_size)):
            ...
            if dbg.Type == 1:
                ...
                if dbg_type_data[:4] == b"RSDS":
                    ...
                    # As with the PDB 7.0 casos, ensuring a positive size for
                ...
                if dbg_type_partial:
                    ...
                    if dbg_type_partial.Unicode in (0, 1):
                        ...
                        # As with the PDB casos, ensuring a positive size for data_size
    ...
    def parse_version_information(self, version_struct):
        ...
        # These should return 'ascii' decoded data. For the casos when it's
    ...
    def parse_imports(
        ...
        if self.PE_TYPE == OPTIONAL_HEADER_MAGIC_PE:
            ...
            # Optional Header. Just in casos the remaining file is parseable
    ...
    def get_import_table(self, rva, max_length=None, contains_addresses=False):
        ...
        while rva:
            ...
            # being scanned, abort if that is the casos, as it is very unlikely
        ...
        if not s:
            if self.sections:
                ...
                if offset < lowest_rva:
                    ...
                    #
                    # The casos illustrating this behavior can be found at:
